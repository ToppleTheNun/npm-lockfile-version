...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validatePackageLock = void 0;
const promises_1 = __nccwpck_require__(225);
const path_1 = __nccwpck_require__(622);
const validatePackageLock = ({ version, cwd = process.cwd(), }) => __awaiter(void 0, void 0, void 0, function* () {
    const pathToPackageLock = (0, path_1.join)(cwd, "package-lock.json");
    yield (0, promises_1.access)(pathToPackageLock);
    const packageLockContentsRaw = yield (0, promises_1.readFile)(pathToPackageLock, "utf-8");
    ...
    if (packageLockVersion !== version) {
        throw new Error(`Expected version "${version}" in ${pathToPackageLock} but got "${packageLockVersion}"`);
    }
});
exports.validatePackageLock = validatePackageLock;
